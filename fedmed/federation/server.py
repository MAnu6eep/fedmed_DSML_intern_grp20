...
using FedAvg and FedProx strategies.
"""
...
def get_initial_parameters(
    ...
    """Convert the initial PyTorch model parameters into Flower Parameters."""
...
def create_fedprox_strategy(
    ...
    """
    Create a configurable FedProx strategy.

    proximal_mu controls the strength of the proximal
    regularization applied during local client training.
    """
